...
HD_PWD='C:/Users/hatsu/final_10/final_10.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dodge_game.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dodge_game.tcl -notrace
