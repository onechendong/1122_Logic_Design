...
HD_PWD='C:/Users/hatsu/final_10/final_10.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dodge_game.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dodge_game.tcl
